...
for vidcount=9:9
    ...
    vidObj = VideoReader(['E:\PROJECTS\VideoForgery\video_tampering_dataset\videos\h264_lossy_q10\' vid '_forged_enc10.avi']);
    ...
    for i=1:numImgs-1
        ...
        imwrite(R(i).cdata,['E:\PROJECTS\VideoForgery\output2\' num2str(vidcount) '\' num2str(i) '.jpg'], 'JPEG');
        if mod(i,9) == 1 || mod(i,9) == 4 || mod(i,9) == 7
            F = ccpev548(['E:\PROJECTS\VideoForgery\output2\' num2str(vidcount) '\' num2str(i) '.jpg'],75);
            for j=1:548
                d(indexes,j) = F(j);
            end
...
save E:\PROJECTS\VideoForgery\stego.mat d names -v7.3;